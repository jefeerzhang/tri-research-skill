...
[![Version](https://img.shields.io/badge/version-6.5.0-blue)](skills/tri-research/CHANGELOG.md)
...
Tri Research 依赖多个搜索后端，其中 **AnySearch / SciVerse / Exa 为必选**（AnySearch 为 `recommended`，匿名可用但建议配置）：
